...
-	Create a new Bucket called `alpha` in the Demo Compartment (or the Compartment you have been assigned).  Note you may have already created this earlier as part of the setup.  If so just review these steps.
